...
class ProjectSelect2ViewListener < Redmine::Hook::ViewListener
  def view_layouts_base_html_head(context)
      javascript_include_tag('select2-3.4.5/select2.js', :plugin => :redmine_project_select2) +
      javascript_include_tag('redmine_project_select2.js', :plugin => :redmine_project_select2) +
      stylesheet_link_tag('select2-3.4.5/select2.css', :plugin => :redmine_project_select2)
  end
end
